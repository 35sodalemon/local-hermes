...
TIPS = [
    ...
    "组合多个引用："请检查 @file:main.py 和 @file:test.py 的一致性"。",
    ...
    "你对 agent 的纠正（"不对，应该这样做"）通常会自动保存到记忆中。",
    ...
    # --- Cron & Scheduling ---
    "定时任务可附加技能：hermes cron add --skill blogwatcher "检查新帖子"。",
    ...
    "过长的危险命令（超过 70 字符）在审批提示中会获得"查看"选项，先看全文再决定。",
    ...
    "上下文文件支持 10+ 种提示注入模式检测 — 隐形 Unicode、"忽略指令"、exfiltration 尝试等。",
